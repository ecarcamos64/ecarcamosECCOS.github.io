...
function irProv(id) {
  ...
  setTimeout(function () {
    var modalEl = document.getElementById('modalProv');
...
if (botonMenu && navMenu) {
  botonMenu.addEventListener('click', function () {
    ...
    setTimeout(function () {
      var abierto = navMenu.classList.toggle('show');
...
dropdowns.forEach(function (toggle) {
  toggle.addEventListener('click', function (e) {
    ...
    var abierto = item.classList.toggle('show');
...
var cerrarModal = document.querySelector('#modalProv .btn-close');
if (cerrarModal) {
